import {
    all,
    run
} from "../config/db.js"; // Ensure your DB client includes promise or callback bindings
import {
    SKINS_BUY_IN
...
export const buildSkinsReport = async (selectedWeekId) => {
    ...
    const {
        startHole,
        endHole
    } = getWeekHoleRange(selectedWeekId);
